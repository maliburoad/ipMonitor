...
public class another2 extends Application {
    ...
    public void start(Stage stage) {
        ...
        // --- Menu File
        Menu menuFile = new Menu("Dobra");
 
        // --- Menu Edit
        Menu menuEdit = new Menu("Zmiana");
    ...
    private class PageData {
        ...
        public PageData(String name, String description, String binNames) {
            ...
            image = new Image(getClass().getResourceAsStream("prezes.jpeg"));
        }
    }
}